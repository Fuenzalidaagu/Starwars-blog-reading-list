	...
	return (
			...
			<div className="row g-0">
			  <div className="col-md-4">
				<img src="https://rare-gallery.com/uploads/posts/1082805-illustration-Star-Wars-planet-space-minimalism-artwork-Earth-cartoon-circle-atmosphere-TIE-Fighter-Death-Star-line-number-screenshot-font-astronomical-object.jpg" className="img-fluid rounded-start " alt="..."/>
			  </div>
